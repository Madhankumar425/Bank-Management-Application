...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        existingGroup.add(r3);
        existingGroup.add(r4);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (aadhar.isEmpty() || pan.isEmpty()) {
                ...
                Conn c1 = new Conn();
                String q2 = "INSERT INTO signup2 (formno, religion, category, income, education, occupation, pan, aadhar, seniorcitizen, existingaccount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                PreparedStatement pstmt = c1.c.prepareStatement(q2);
