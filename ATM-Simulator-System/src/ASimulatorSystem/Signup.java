    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (name.isEmpty() || fname.isEmpty() || dob.isEmpty() || gender == null || email.isEmpty() ||
                ...
                Conn c1 = new Conn();
                String q1 = "INSERT INTO signup (formno, name, fname, dob, gender, email, marital, address, city, pincode, state) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                PreparedStatement pstmt = c1.c.prepareStatement(q1);
