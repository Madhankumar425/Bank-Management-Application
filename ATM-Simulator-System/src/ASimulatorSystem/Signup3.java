...
public class Signup3 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String cardno = String.format("%016d", Math.abs(first7)); // Ensures 16 digits

        long first3 = (ran.nextLong() % 9000L) + 1000L;
        String pin = String.format("%04d", Math.abs(first3));     // Ensures 4 digits
        ...
        try {
            if (ae.getSource() == b1) {
                if (atype == null || !c7.isSelected()) {
                    JOptionPane.showMessageDialog(null, "Fill all the required fields or accept the declaration");
                } else {
                    Conn c1 = new Conn();
                    String q1 = "INSERT INTO signup3 (formno, account_type, card_number, pin, facilities) VALUES (?, ?, ?, ?, ?)";
